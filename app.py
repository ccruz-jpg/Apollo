...
st.set_page_config(page_title="Apollo Lead Extractor", layout="wide")
...
st.markdown("Consulta Apollo, exporta a Excel o súbelo directamente a Google Drive.")
...
with st.sidebar:
    ...
    total_pages = st.number_input("Número de páginas", min_value=1, max_value=20, value=1)

search_button = st.button("Buscar en Apollo")
